...
export const SliderAds: FC = () => {
  return (
    <div className="w-full h-[527px] flex-col justify-start items-center gap-8 inline-flex px-[60px]">
      <div className="w-[1320px] grow shrink basis-0 flex-col justify-center items-start gap-8 inline-flex">
        ...
        <div className="self-stretch justify-start items-start gap-6 inline-flex">
          ...
          <Image
            ...
            alt=""
          />
          <Image className="w-[312px] h-[418px] rounded" src={Ad3} alt="" />
          <Image className="w-[312px] h-[418px] rounded" src={Ad1} alt="" />
        </div>
      </div>
